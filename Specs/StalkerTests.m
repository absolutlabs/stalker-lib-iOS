...
describe(@"objectWithStalker", ^{
    ...
    it(@"should be able to observer changes", ^ {
        ...
        [objectWithStalker.stalker whenPath:@"one" changeForObject:objectToBeObserved
        ...
        [objectWithStalker.stalker whenPath:@"two" changeForObject:objectToBeObserved
                                    options:(NSKeyValueObservingOptionInitial|NSKeyValueObservingOptionNew|NSKeyValueObservingOptionOld)
                                       then:^(NSMutableDictionary *object, NSDictionary *change) {
    ...
    it(@"should be able to listen to notifications", ^ {
        ...
        [objectWithStalker.stalker when:testNotification then:^(NSNotification *notification) {
